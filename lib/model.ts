...
export type Data = {startDate?:string;endDate?:string;author?:string;title?:string;description?:string;team?:string;assignee?:string;status?:string;due?:string;priority?:string;blocked?:boolean;category?:string;date?:string;time?:string;repo?:string;target?:string;text?:string;line?:number;ref?:string;path?:string;resolved?:boolean;source?:{repo:string;path:string;ref:string;line?:number}};
